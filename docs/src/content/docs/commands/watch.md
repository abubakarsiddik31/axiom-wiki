...
Files are tracked by SHA-256 hash — unchanged files are skipped automatically, and modified files are re-ingested. A compilation lock prevents concurrent ingests when multiple files arrive at once.
