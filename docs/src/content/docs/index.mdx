...
<CardGrid stagger>
  ...
  <Card title="Map your codebase" icon="seti:folder">
    Run `axiom-wiki map` inside any project to generate structured documentation — architecture, modules, tech stack — with one command.
  </Card>
